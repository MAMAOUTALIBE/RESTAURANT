...
const orderSteps = [
  {
    step: "01",
    title: "Choisissez",
    text: "Kebab grillé, pide, lahmacun, desserts et boissons.",
  },
  {
    step: "02",
    title: "Validez",
...
const practicalItems: {
  ...
  },
  {
    ...
    text: "Préparation quotidienne et recettes turques.",
    Icon: ShieldCheck,
  },
];
  ...
  return (
    <section className="bg-[#F8F3EA] py-8 text-ink sm:py-10">
      <div className="container-page">
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.2fr] lg:items-start">
          <Reveal>
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-7 text-ink/68 sm:text-base">
                Le parcours est direct : vous choisissez vos plats, vous
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  className="inline-flex min-h-[3.25rem] items-center justify-center gap-2.5 rounded-full border border-[#25D366]/45 bg-[#25D366]/10 px-6 py-3 text-sm font-bold text-ink transition hover:-translate-y-0.5 hover:border-[#25D366] hover:bg-[#25D366]/18 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/50"
                >
                ...
                <a
                  href={phoneHref}
                  className="inline-flex min-h-[3.25rem] items-center justify-center gap-2.5 rounded-full border border-ink/12 bg-white px-6 py-3 text-sm font-bold text-ink transition hover:-translate-y-0.5 hover:border-gold-600 hover:text-gold-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/60"
                >
        ...
        <Reveal delay={0.24}>
          <div className="mt-7 flex flex-col gap-2 border-t border-ink/10 pt-4 text-sm text-ink/62 sm:flex-row sm:items-center sm:justify-between">
