...
export default function CgvPage() {
  return (
    <LegalLayout title="Conditions générales de vente" updatedAt="31 mai 2026">
      ...
      <p>
        Les présentes CGV régissent les ventes de plats réalisées par{" "}
        {siteConfig.name} via le site {siteConfig.url}.
      </p>

      <h2>Article 2 — Prix</h2>
      <p>
        Les prix sont indiqués en euros toutes taxes comprises (TTC). {siteConfig.name}{" "}
        se réserve le droit de modifier ses prix à tout moment, les plats étant
        facturés sur la base des tarifs en vigueur au moment de la commande.
      </p>
      ...
      <p>
        ...
        de rétractation ne s&apos;applique pas aux denrées alimentaires
        périssables.
      </p>
