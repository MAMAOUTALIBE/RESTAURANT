...
/** Métadonnées SEO dynamiques par plat (titre, description, image de partage). */
export async function generateMetadata({
  ...
  const description = `${dish.description} — ${formatPrice(dish.price)}. Commandez ${dish.name} chez ${siteConfig.name}, restaurant africain à Juvisy-sur-Orge.`;
  return {
    title: dish.name,
    description,
            ...
            <div>
              ...
              {!dish.available ? (
                <p className="mt-6 rounded-xl border border-red-500/30 bg-red-500/10 p-4 text-red-300">
                  Ce plat est actuellement épuisé.
                </p>
              ) : (
                <div className="mt-6">
                  <DishOrderPanel
